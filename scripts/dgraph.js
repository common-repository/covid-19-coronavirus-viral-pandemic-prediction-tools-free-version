...
registerBlockType( 'coronavirus-spread-prediction-graphs-free/cspgf-pgraph', {
    ...
    edit: (function( props ) {
		...
		return gcel(
            ...
            gcel(
                ...
                'COVID-19 Population Decline Chart',
                gcel(
                    'div', 
                    ...
                    gcel(
                        ...
                        'This block is used to display a prediction chart for the count of the population decline for a pandemic.'
                    )
                )
			),
            gcel(
            ...
            gcel(
                ...
                gcel(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Input a comma separated list of data labels to use in the graph. Default is: Population Decline'
                )
            ),
			gcel(
				'textarea',
				{ rows:1,placeholder:'Population Decline', value: datalabels, onChange: updateMessage14, className: 'coderevolution_gutenberg_input' }
			),
            gcel(
				'br'
			),
