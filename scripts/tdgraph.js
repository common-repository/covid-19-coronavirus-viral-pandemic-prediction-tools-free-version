...
registerBlockType( 'coronavirus-spread-prediction-graphs-free/cspgf-tidg', {
    title: 'COVID-19 Total Infected Total Death Chart',
    icon: 'chart-area',
    category: 'embed',
    attributes: {
        starting_population : {
    ...
    edit: (function( props ) {
		...
		return gcel(
            ...
            gcel(
                ...
                'COVID-19 Total Infected Total Death Chart',
                gcel(
                    'div', 
                    ...
                    gcel(
                        ...
                        'This block is used to display a prediction chart for the count of the total infected and total deaths for a pandemic.'
                    )
                )
			),
            gcel(
            ...
            gcel(
                ...
                gcel(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Input a comma separated list of 2 data labels to use in the graph. Default is: Total Infected, Total Deaths'
                )
            ),
			gcel(
				'textarea',
				{ rows:1,placeholder:'Total Infected, Total Deaths', value: datalabels, onChange: updateMessage14, className: 'coderevolution_gutenberg_input' }
			),
            gcel(
				'br'
			),
