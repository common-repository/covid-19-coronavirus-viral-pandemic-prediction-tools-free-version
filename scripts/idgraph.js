...
registerBlockType( 'coronavirus-spread-prediction-graphs-free/cspgf-nidg', {
    title: 'COVID-19 New Infected New Death Chart',
    icon: 'chart-line',
    category: 'embed',
    attributes: {
        starting_population : {
    ...
    edit: (function( props ) {
		...
		return gcel(
            ...
            gcel(
                ...
                'COVID-19 New Infected New Death Chart',
                gcel(
                    'div', 
                    ...
                    gcel(
                        ...
                        'This block is used to display a prediction chart for newly infected and new deaths caused by the COVID-19 virus.'
                    )
                )
			),
            gcel(
            ...
            gcel(
                ...
                gcel(
                    'div', 
                    {className:'bws_hidden_help_text'},
                    'Input a comma separated list of 2 data labels to use in the graph. Default is: New Infected, New Deaths'
                )
            ),
			gcel(
				'textarea',
				{ rows:1,placeholder:'New Infected, New Deaths', value: datalabels, onChange: updateMessage14, className: 'coderevolution_gutenberg_input' }
			),
            gcel(
				'br'
			),
